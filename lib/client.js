...
function applyComputerUseClient(ctx, { openPanel, renderPane, integrated = false } = {}) {
  ...
  ctx.slots.inject("sidebar.right.pane.tab", () => ctx.slots.register({ name: "sidebar.right.pane.tab", key: id }, (props) => renderPane ? renderPane(props) : /* @__PURE__ */ import_react17.default.createElement(ComputerPane, { ...props, conversation: ctx.get("conversation") })));
