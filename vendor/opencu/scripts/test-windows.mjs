...
try {
  ...
  await step('core', process.execPath, ['--test', '--test-reporter=tap', '--test-concurrency=1', 'test/integration-ownership.test.mjs', 'test/computer-use-runtime.test.mjs', 'test/dsh-install.test.mjs']);
  await step('browser', process.execPath, ['--test', '--test-reporter=tap', '--test-concurrency=1', 'test/computer-use-browser.test.mjs', 'test/computer-use-windows-managed.test.mjs', 'test/computer-use-view.test.mjs', 'test/computer-use-files.test.mjs', 'test/computer-use-windows-install.test.mjs', 'test/computer-use-windows-bridge.test.mjs', 'test/computer-use-windows-browser.test.mjs']);
  await step('frontend', process.execPath, ['--test', '--test-reporter=tap', '--test-concurrency=1', 'test/computer-use-annotation.test.mjs', 'test/computer-use-ui.test.mjs', 'test/computer-use-windows-setup-ui.test.mjs']);
